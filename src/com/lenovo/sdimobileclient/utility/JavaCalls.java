...
public class JavaCalls {
	private final static String LOG_TAG = "PCR.JavaCalls";
	...
	public static <T> T callMethod(Object targetInstance, String methodName, Object... args) {
		try {
			...
			Log.w(LOG_TAG, "Meet exception when call Method '"
					+ methodName
					+ "' in "
					+ targetInstance, e);
			return null;
	...
	public static <T> T callStaticMethod(String className, String methodName, Object... args) {
		try {
			...
			Log.w(LOG_TAG, "Meet exception when call Method '" + methodName + "' in " + className,
					e);
			return null;
		}
	}
	...
	@SuppressWarnings("unchecked")
	public static <T> T callStaticMethodOrThrow(final Class<?> clazz, String methodName,
